                        ...
                        <div key={product.id} className="group">
                            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7 relative">
                                ...
                                <img
                                    ...
                                    className="pointer-events-none h-full w-full object-scale-down object-center group-hover:opacity-75"
                                />
                            </div>
                            <div className='sm:block flex justify-between items-baseline'>
                                ...
                                <p className="mt-1 text-lg font-medium text-gray-700">{product.unit_price}</p>
                            </div>
                        </div>
                    ))}
                </div>
