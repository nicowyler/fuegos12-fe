...
const navigation = [
  ...
  { name: 'Historial de compras', href: '#', current: false },
]
                  ...
                  <div className="flex items-center">
                    <div className="flex-shrink-0 flex items-center gap-2">
                      <img
                        className="h-8 w-8"
                        src={fireIcon}
                        alt="Fuegos 12 de Julio"
                      />
                      <h2 className='text-f12-creame bold text-lg'>Fuegos 12 de Julio</h2>
                    </div>
                      ...
                      <Menu as="div" className="relative ml-3">
                        ...
                        >
                          <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                            ...
                            <Menu.Item>
                              <button onClick={logOut} className='block px-4 py-2 text-sm text-gray-700 w-full text-left   hover:bg-gray-100 '>
                                LogOut
                              </button>
                            </Menu.Item>
                          </Menu.Items>
